...
public class CuentaBancaria {
    ...
    public void depositar(double monto){
        ...
        System.out.println("Se ha realizado un depósito de $" + monto + ". Saldo actual es de $" + saldo);
    }
    ...
    public void retirar(double monto){
        if (saldo >= monto){
            ...
            System.out.println("No se puede realizar el retiro, su saldo es de $" +saldo);
        }
    }
